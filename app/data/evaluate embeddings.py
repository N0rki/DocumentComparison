# Updated evaluate_embeddings.py to use `process_pdf()` from extract_data.py for robust title + abstract
...
PDF_DIR = os.path.join(BASE_DIR, 'documents', 'pdfs')
...
# Save the final script version
final_path = "evaluation_scripts/evaluate_embeddings.py"
